...
public class CreateCourse extends AppCompatActivity implements View.OnScrollChangeListener, BottomNavigationView.OnNavigationItemSelectedListener  {
    ...
    private JsonArrayRequest getDataFromServer(int requestCount){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(webURL + String.valueOf(requestCount),
                ...
                (error) -> {
                    ...
                    Toast.makeText(CreateCourse.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                });
