...
public class LoginActivity extends AppCompatActivity {
    ...
    private void setName(String JSON) throws JSONException {
        ...
        if (USER.STUDENT) {
            USER.FNAME = NAMES.getString("Student_FName");
            USER.LNAME = NAMES.getString("Student_LName");
            ...
            USER.FNAME = NAMES.getString("Instructor_FName");
            USER.LNAME = NAMES.getString("Instructor_LName");
